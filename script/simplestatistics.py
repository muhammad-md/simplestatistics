...
class mainwindow:
    def __init__(self, master):
        ...
        self.btn11 = tk.Button(self.master, text ="BAR CHART", font = fontStyle, command = self.clearpage3)
        self.btn11.place(relx = 0.15, rely = 0.40, anchor = CENTER)
        self.btn22 = tk.Button(self.master, text ="PIE CHART", font = fontStyle, command = self.clearpage4)
        self.btn22.place(relx = 0.15, rely = 0.60, anchor = CENTER)
